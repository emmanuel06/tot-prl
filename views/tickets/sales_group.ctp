<script>
	var ventas = '<?php echo $html->url(array('action'=>'sales_group')) ?>';
	...
	$(function() {
		...
		$("#filtrar").click(function(){
			...
			location = ventas + '/' + group + '/' + since + '/' + until;
		});
...
<div class="tickets index">
	<h2>Ventas Del Grupo <?php echo $group_name ?></h2>
	<table>
		<tr>
			<td>
			<?php
				echo $form->input('group',array('type'=>'hidden','value'=>$group));
	...
	<div class="paging">
		<?php echo $paginator->prev('<< anterior', array('url'=>array('action'=>'sales_new',$since,$until,$group)), null, array('class'=>'disabled'));?>
	 | 	<?php echo $paginator->numbers(array('url'=>array('action'=>'sales_new',$since,$until,$group)));?>
		<?php echo $paginator->next('siguiente >>', array('url'=>array('action'=>'sales_new',$since,$until,$group)), null, array('class' => 'disabled'));?>
	</div>
